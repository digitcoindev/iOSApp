//
//  MultisigMosaicDefinitionCreationTransactionDetailsViewController.swift
//
...
///
final class MultisigMosaicDefinitionCreationTransactionDetailsViewController: UIViewController {
    ...
    internal func reloadTransactionDetails() {
        ...
        case .multisigTransaction:
            ...
            case .mosaicDefinitionCreationTransaction:
                ...
                transactionTypeLabel.text = "Multisig Mosaic Definition Creation Transaction"
    ...
    private func fetchMultisigAccountData() {
        ...
        NEMProvider.request(NEM.accountData(accountAddress: AccountManager.sharedInstance.generateAddress(forPublicKey: mosaicDefinitionCreationTransaction.signer))) { [weak self] (result) in
    ...
    @IBAction func signMultisigTransaction(_ sender: UIButton) {
        ...
        if let multisigTransaction = multisigTransaction {
            ...
            case .mosaicDefinitionCreationTransaction:
                ...
                let transactionMultisigAccountAddress = AccountManager.sharedInstance.generateAddress(forPublicKey: mosaicDefinitionCreationTransaction.signer)
...
extension MultisigMosaicDefinitionCreationTransactionDetailsViewController: UITableViewDelegate, UITableViewDataSource {
