...
open class TransactionManager {
     ...
     */
    func signTransaction(_ transaction: Transaction, account: Account) -> RequestAnnounce {
    ...
    fileprivate func generateCommonTransactionPart(forTransaction transaction: Transaction) -> [UInt8] {
        ...
        transactionFeeByteArray = String(Int(transaction.fee * 1000000), radix: 16).asByteArrayEndian(8)
