...
//        }
    ...
    fileprivate func startRefreshing() {
        ...
        refreshTimer = Timer.scheduledTimer(timeInterval: TimeInterval(Constants.updateInterval), target: self, selector: #selector(AccountDashboardViewController.refreshTransactionOverview), userInfo: nil, repeats: true)
    }
...
extension AccountDashboardViewController: UITableViewDataSource {
...
extension AccountDashboardViewController: UITableViewDelegate {
