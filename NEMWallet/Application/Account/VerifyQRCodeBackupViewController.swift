//
//  VerifyQRCodeBackupViewController.swift
//
...
///
final class VerifyQRCodeBackupViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        informationLabel.text = "Verify that the backup is correct by scanning the backup QR code you've saved in the previous step and entering the related password"
    ...
    fileprivate func verifyPassword(password: String) {
        ...
        do {
            ...
            let accountCreationSuccessfulAlert = UIAlertController(title: "Verification Successful", message: "The backup QR code you scanned and the password you provided were correct! You have successfully backed up your account", preferredStyle: .alert)
        ...
        } catch AccountImportValidation.wrongBackupProvided {
                
            let verificationFailureAlert = UIAlertController(title: "Error", message: "Wrong backup scanned", preferredStyle: .alert)
            ...
            let accountCreationFailureAlert = UIAlertController(title: "Error", message: "Couldn't verify account", preferredStyle: .alert)
    ...
    fileprivate func validatePassword(password: String) throws -> Bool {
        ...
        guard let userEnteredAccountPrivateKey = HashManager.AES256Decrypt(inputText: accountEncryptedPrivateKey, key: passwordHash!.hexadecimalString())?.nemKeyNormalized() else { throw AccountImportValidation.wrongPasswordProvided }
        
        let accountPrivateKey = AccountManager.sharedInstance.decryptPrivateKey(encryptedPrivateKey: account!.privateKey)
        guard accountPrivateKey == userEnteredAccountPrivateKey else { throw AccountImportValidation.wrongBackupProvided }
        
        return true
    }
}

extension VerifyQRCodeBackupViewController: AVCaptureMetadataOutputObjectsDelegate {
